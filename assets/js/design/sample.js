...
export const SAMPLE_CONTENT = Object.freeze({
  ...
  services: [{ name: 'Barangay services', description: 'Describe the service and how residents can apply.', requirements: 'Published requirements appear here.', fee_text: 'Refer to the official service record.' }, { name: 'Resident assistance', description: 'A clear starting point for the help residents need.' }, { name: 'Document requests', description: 'Requirements, fees, and processing details in one place.' }],
